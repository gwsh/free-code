...
function ElicitationFormDialog({
  ...
  useNotifyAfterTimeout('GWSH Claude Code needs your input', 'elicitation_dialog');
...
function ElicitationURLDialog({
  ...
  useNotifyAfterTimeout('GWSH Claude Code needs your input', 'elicitation_url_dialog');
