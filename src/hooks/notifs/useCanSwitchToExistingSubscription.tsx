...
async function _temp2() {
  ...
  return {
    ...
    jsx: <Text color="suggestion">Use your existing Claude {subscriptionType} plan with GWSH Claude Code<Text color="text" dimColor={true}>{" "}· /login to activate</Text></Text>,
    priority: "low"
  };
}
