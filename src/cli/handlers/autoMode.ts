...
const CRITIQUE_SYSTEM_PROMPT =
  'You are an expert reviewer of auto mode classifier rules for GWSH Claude Code.\n' +
  '\n' +
  'GWSH Claude Code has an "auto mode" that uses an AI classifier to decide whether ' +
