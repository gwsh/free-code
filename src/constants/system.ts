...
const DEFAULT_PREFIX = `You are GWSH Claude Code, Anthropic's official CLI for Claude.`
const AGENT_SDK_CLAUDE_CODE_PRESET_PREFIX = `You are GWSH Claude Code, Anthropic's official CLI for Claude, running within the Claude Agent SDK.`
