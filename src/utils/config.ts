...
export type GlobalConfig = {
  ...
  firstStartTime?: string // ISO timestamp when GWSH Claude Code was first started on this machine
  ...
  // GWSH Claude Code usage tracking
  claudeCodeFirstTokenDate?: string // ISO timestamp of the user's first GWSH Claude Code OAuth token
  ...
  // GWSH Claude Code hint protocol state (<claude-code-hint /> tags from CLIs/SDKs).
