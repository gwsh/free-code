...
const APP_NAME = 'GWSH Claude Code URL Handler'
const DESKTOP_FILE_NAME = 'claude-code-url-handler.desktop'
const MACOS_APP_NAME = 'GWSH Claude Code URL Handler.app'
...
<dict>
  ...
  <array>
    <dict>
      ...
      <string>GWSH Claude Code Deep Link</string>
...
Name=${APP_NAME}
Comment=Handle ${DEEP_LINK_PROTOCOL}:// deep links for GWSH Claude Code
