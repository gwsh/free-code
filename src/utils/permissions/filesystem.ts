...
// Always ask when GWSH Claude Code tries to edit its own config files
 ...
 * This is a per-user temporary directory used by GWSH Claude Code for all temp files.
 *
 ...
 * - MCP CLI state files (managed internally by GWSH Claude Code)
