 ...
 * Initialized during GWSH Claude Code startup.
 */
 ...
 * asynchronously during GWSH Claude Code startup. Use getInitializationStatus() to
 ...
 *
 * This function is called during GWSH Claude Code startup. It synchronously creates
 ...
 *
 * This should be called during GWSH Claude Code shutdown. Stops all running LSP servers
