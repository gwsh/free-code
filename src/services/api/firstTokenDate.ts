...
/**
 * Fetch the user's first GWSH Claude Code token date and store in config.
 * This is called after successful login to cache when they started using GWSH Claude Code.
 */
